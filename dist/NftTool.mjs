(function(){"use strict";try{if(typeof document!="undefined"){var e=document.createElement("style");e.appendChild(document.createTextNode('._wrapper_7i792_21{margin:1em auto;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-ms-flex-direction:row;flex-direction:row;-webkit-box-align:stretch;-ms-flex-align:stretch;align-items:stretch;padding:10px 0;gap:26px}._media-wrapper_7i792_31{-ms-flex-preferred-size:283px;flex-basis:283px;-webkit-box-flex:0;-ms-flex-positive:0;flex-grow:0;-ms-flex-negative:0;flex-shrink:0;border-radius:16px;overflow:hidden;background-color:#f0f0f0}._media_7i792_31{width:100%;height:100%;-o-object-fit:cover;object-fit:cover;border-radius:16px;overflow:hidden}._column_7i792_50{-webkit-box-flex:1;-ms-flex-positive:1;flex-grow:1;width:100%;display:-webkit-inline-box;display:-ms-inline-flexbox;display:inline-flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;-webkit-box-align:stretch;-ms-flex-align:stretch;align-items:stretch;gap:16px}._title_7i792_60{font-style:normal;font-weight:700;font-size:20px;line-height:22px}._title_7i792_60:empty:after{content:"";display:block;height:14px;width:79px;border-radius:11px;background-color:#eff0f1}._collection_7i792_76{margin-top:4px;font-weight:regular;font-size:14px;line-height:22px;color:#707684}._collection_7i792_76:empty:after{margin-top:12px;margin-bottom:12px;content:"";display:block;height:10px;width:149px;border-radius:11px;background-color:#eff0f1}._form-label_7i792_1{display:block;font-weight:700;font-size:14px;padding-bottom:6px}._form-input_7i792_1{width:100%;padding:8px 12px;border-radius:4px;border:1px solid #EFF0F1;background-color:#f8f8f8;font-size:14px;line-height:1.4;outline:none}._form-input_7i792_1:focus{border-color:#007aff}._form-select_7i792_1{width:100%;padding:8px 12px;border-radius:4px;border:1px solid #EFF0F1;background-color:#f8f8f8;font-size:14px;line-height:1.4;outline:none;background-repeat:no-repeat;background-position:right 10px bottom 50%;cursor:pointer;appearance:none;-moz-appearance:none;-webkit-appearance:none}._form-select_7i792_1:focus{border-color:#007aff}')),document.head.appendChild(e)}}catch(i){console.error("vite-plugin-css-injected-by-js",i)}})();
...
const f = "_wrapper_7i792_21", u = "_media_7i792_31", k = "_column_7i792_50", w = "_title_7i792_60", g = "_collection_7i792_76", s = {
  wrapper: f,
  "media-wrapper": "_media-wrapper_7i792_31",
  media: u,
  column: k,
  title: w,
  collection: g,
  "form-label": "_form-label_7i792_1",
  "form-input": "_form-input_7i792_1",
  "form-select": "_form-select_7i792_1"
