(function(){"use strict";try{if(typeof document!="undefined"){var o=document.createElement("style");o.appendChild(document.createTextNode('._wrapper_ctyn1_1{--color-background: #F8F8F8;--color-border: #EFF0F1;--color-border-focus: #007AFF;--color-media-background: #F0F0F0;--color-card-title: #000;--color-card-collection: #707684;--border: 1px solid var(--color-border);--card-box-shadow: 0px 2px 3px rgba(0, 0, 0, .03);margin:1em auto;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-ms-flex-direction:row;flex-direction:row;-webkit-box-align:start;-ms-flex-align:start;align-items:flex-start;padding:10px 0;gap:26px}._media-wrapper_ctyn1_24{height:283px;-ms-flex-preferred-size:283px;flex-basis:283px;-webkit-box-flex:0;-ms-flex-positive:0;flex-grow:0;-ms-flex-negative:0;flex-shrink:0;border-radius:16px;overflow:hidden;background-color:var(--color-media-background)}._media_ctyn1_24{width:100%;height:100%;-o-object-fit:cover;object-fit:cover;border-radius:16px;overflow:hidden}._column_ctyn1_44{-webkit-box-flex:1;-ms-flex-positive:1;flex-grow:1;width:100%;display:-webkit-inline-box;display:-ms-inline-flexbox;display:inline-flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;-webkit-box-align:stretch;-ms-flex-align:stretch;align-items:stretch;gap:16px}._title_ctyn1_54{font-style:normal;font-weight:700;font-size:20px;line-height:22px}._title_ctyn1_54:empty:after{content:"";display:block;height:14px;width:79px;border-radius:11px;background-color:var(--color-border)}._collection_ctyn1_70{margin-top:4px;font-weight:regular;font-size:14px;line-height:22px;color:var(--color-card-collection)}._collection_ctyn1_70:empty:after{margin-top:12px;margin-bottom:12px;content:"";display:block;height:10px;width:149px;border-radius:11px;background-color:var(--color-border)}._form-label_ctyn1_1{display:block;font-weight:700;font-size:14px;padding-bottom:6px}._form-input_ctyn1_1{width:100%;padding:8px 12px;border-radius:4px;border:var(--border);background-color:var(--color-background);font-size:14px;line-height:1.4;outline:none}._form-input_ctyn1_1:focus{border-color:var(--color-border-focus)}._form-select_ctyn1_1{width:100%;padding:8px 12px;border-radius:4px;border:var(--border);background-color:var(--color-background);font-size:14px;line-height:1.4;outline:none;background-repeat:no-repeat;background-position:right 10px bottom 50%;cursor:pointer;appearance:none;-moz-appearance:none;-webkit-appearance:none}._form-select_ctyn1_1:focus{border-color:var(--color-border-focus)}')),document.head.appendChild(o)}}catch(e){console.error("vite-plugin-css-injected-by-js",e)}})();
...
const f = "_wrapper_ctyn1_1", u = "_media_ctyn1_24", k = "_column_ctyn1_44", w = "_title_ctyn1_54", g = "_collection_ctyn1_70", s = {
  wrapper: f,
  "media-wrapper": "_media-wrapper_ctyn1_24",
  media: u,
  column: k,
  title: w,
  collection: g,
  "form-label": "_form-label_ctyn1_1",
  "form-input": "_form-input_ctyn1_1",
  "form-select": "_form-select_ctyn1_1"
